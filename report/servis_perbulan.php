...
<html>
    <head>
        <title>Cetak Data Servis Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>LAPORAN DATA SERVIS BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
						...
						<tbody>
                            ...
                            $sql = "SELECT * FROM data_service WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
