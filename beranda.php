<div class="container">
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info" style="background-color: #606061;">
                <strong>Selamat Datang di F3I Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Servis Komputer</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nama Barang</th><th>Tipe</th><th>Jenis Kerusakan</th><th>Tanggal Masuk</th><th>Penerima</th><th>No Rak</th><th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" name="login" value="login"
                                        style="background-color: #606061; "><span class="fa fa-unlock-alt"></span>
                                    Login Sistem
                                </button>
                            </div>
                    </form>
